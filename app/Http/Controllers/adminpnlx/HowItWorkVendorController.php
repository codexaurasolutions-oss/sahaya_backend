...
class HowItWorkVendorController extends Controller
{
    public $model = 'how-it-works-vendor';
    ...
    public function index(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if ($validator->fails()) {
                ...
                Session()->flash('success', ucfirst('How It Works Vendor' . " has been added successfully"));
